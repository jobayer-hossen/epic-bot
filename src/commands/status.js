...
module.exports = {
  ...
  async execute(message, args, client) {
    try {
      ...
      const status =
        ping < 100 ? "✅ Excellent" : ping < 200 ? "✅ Good" : "⚠️ Fair";
      ...
      // Get feature status
      const coinRainStatus = client.features.coinRain
        ? "✅ Active"
        : "❌ Inactive";
      const lootboxStatus = client.features.lootboxSummoning
        ? "✅ Active"
        : "❌ Inactive";
      ...
      // Get AI stats
      const aiStats = client.features.aiChat
        ? client.features.aiChat.getStats()
        : null;
